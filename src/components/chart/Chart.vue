...
firsttrade++;
        ...
        qty = -1*(marginperc*(btcbtc/(btcbtc*this.tickData.exchanges[trades[trades.length-1][0]].close)))/2
        }
        }
        else {
        firsttrade++;
...
if (thepair.indexOf('USD') == -1){
        qty = (marginperc*(btcbtc/(btcbtc*this.tickData.exchanges[trades[trades.length-1][0]].close)))/2
        }
        }
        else{
        firsttrade++
