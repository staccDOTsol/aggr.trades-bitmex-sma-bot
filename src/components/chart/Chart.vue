...
ref = "chartContainer": class = "{ fetching: fetching }": style = "{ height: chartHeight }"
...
v -
    if = "isDirty"
v - tippy = "{ placement: 'bottom' }": title = "
...
still silent
    ...
    <
    div class = "chart__controls chart-controls"
v -
    if = "showControls" >
    <
...
v - tippy: title = "chartAutoScale ? 'Unlock price axis' : 'Lock price axis'" >
    <
    span class = "min-768" > {
        {
            chartAutoScale ? 'AUTO' : 'FREE'
        }
    } < /span> <
    i: class = "{
